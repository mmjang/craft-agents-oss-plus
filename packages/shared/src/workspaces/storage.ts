 ...
 * Default location: ~/.craft-plus/workspaces/
 */
...
/**
 * Get the default workspaces directory (~/.craft-plus/workspaces/)
 */
 ...
 * Returns paths to valid workspaces found in ~/.craft-plus/workspaces/
 */
