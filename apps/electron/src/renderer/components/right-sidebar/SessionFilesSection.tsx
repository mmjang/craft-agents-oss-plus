  ...
  return (
    <div className={cn('flex flex-col h-full min-h-0', className)}>
      ...
      <div className="flex items-center justify-between px-4 pt-4 pb-2 shrink-0 select-none">
        <span className="text-xs font-medium text-muted-foreground">{t('sessionFiles.title', 'Files')}</span>
      </div>
          ...
          <div className="px-4 text-muted-foreground select-none">
            <p className="text-xs">
              {isLoading
                ...
                : t('sessionFiles.empty', 'Files attached or created by this chat will appear here.')}
            </p>
          </div>
        ) : (
