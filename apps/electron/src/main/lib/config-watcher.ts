 ...
 *
 * Watched paths:
 * - ~/.craft-plus/config.json - Main app configuration
 * - ~/.craft-plus/preferences.json - User preferences
 * - ~/.craft-plus/theme.json - App-level theme overrides
 * - ~/.craft-plus/themes/*.json - Preset theme files (app-level)
 * - ~/.craft-plus/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.craft-plus/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.craft-plus/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.craft-plus/permissions/)
